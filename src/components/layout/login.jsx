        ...
        return (
            <Auxiliary >
                ...
                <div className="main-content">
                    {this.state.authenticated ? <Redirect to='/admin' /> : <Redirect to='/login' />}
                    <form onSubmit={(event) => this.validate(event)} id="form" action="http://localhost:8000/admin" method="POST">
